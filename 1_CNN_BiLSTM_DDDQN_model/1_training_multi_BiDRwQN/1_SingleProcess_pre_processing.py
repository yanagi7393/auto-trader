...
processing_file_list = glob.glob('./csv_train/*')
...
file_dir = './'
dir_list = ["csv_train","dataset_csv_train","dataset_csv_train","dataset_indicator_train","dataset_label_train"]
...
for i,lis in enumerate(processing_file_list):
    ...
    if S_stride == 'off':
        for idx in range(span):
            ...
            dataframe_2_save.to_csv(file_dir + 'dataset_csv_train/{}_{}_{}.csv'.format(item,i%train_data_count,idx), index=False)
            ...
            label_dataframe.to_csv(file_dir + 'dataset_label_train/{}_{}_{}.csv'.format(item,i%train_data_count,idx), index=False)
            ...
            dataframe_2.to_csv(file_dir + 'dataset_indicator_train/{}_{}_{}.csv'.format(item,i%train_data_count,idx), index=False)
        ...
        dataframe_csv.to_csv(file_dir + 'dataset_csv_train/{}_{}_{}.csv'.format(item,i%train_data_count,0), index=False)
        print('[{}] {}'.format(i, dataframe_csv.values.shape))
        
        dataframe_label.to_csv(file_dir + 'dataset_label_train/{}_{}_{}.csv'.format(item,i%train_data_count,0), index=False)
        print('[{}] {}'.format(i, dataframe_label.values.shape))
        
        dataframe_indicator.to_csv(file_dir + 'dataset_indicator_train/{}_{}_{}.csv'.format(item,i%train_data_count,0), index=False)
