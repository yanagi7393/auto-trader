...
cellT_fw1 = tf.contrib.rnn.MultiRNNCell([create_one_cell() for _ in range(nb_lstm_layers)], state_is_tuple=True)
cellT_bw1 = tf.contrib.rnn.MultiRNNCell([create_one_cell() for _ in range(nb_lstm_layers)], state_is_tuple=True)
cellT_fw2 = tf.contrib.rnn.MultiRNNCell([create_one_cell() for _ in range(nb_lstm_layers)], state_is_tuple=True)
cellT_bw2 = tf.contrib.rnn.MultiRNNCell([create_one_cell() for _ in range(nb_lstm_layers)], state_is_tuple=True)
